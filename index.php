...
?>
    <main>
        ...
        <section class="work__area ms-bg-2 pt-130 pb-60 p-relative">
            <img class="work__vactor-shape d-none d-xl-block" src="assets/img/work/vector-shape-2.png"
                alt="vector shape">
            <div class="container">
                        ...
                        <div class="work__thumb-wrapper zindex-1 p-relative mb-60 d-inline-block">
                            <div class="work__thumb-inner p-relative zindex-5">
                                <div class="work__thumb m-img">
                                    <img src="assets/img/work/work-thumb-04.png" alt="work image">
                                </div>
                            </div>
            ...
            <div class="container">
                ...
                <div class="ms-fun-brand-wrap ms-fun-brand-bb pb-70 bdFadeUp">
                    ...
                    <div class="ms-fun-brand-item ms-fun-border">
                        <div class="ms-fun-brand-top mb-20">
                            <div class="ms-fun-brand-thumb">
                                <a href="genres-details.html"><img src="assets/img/function-brand/function-brand-02.png"
                                        alt="function brand"></a>
                            </div>
                            <div class="ms-fun-brand-content">
                    ...
                    <div class="ms-fun-brand-item ms-fun-border">
                        <div class="ms-fun-brand-top mb-20">
                            <div class="ms-fun-brand-thumb">
                                <a href="genres-details.html"><img src="assets/img/function-brand/function-brand-03.png"
                                        alt="function brand"></a>
                            </div>
                            <div class="ms-fun-brand-content">
                    ...
                    <div class="ms-fun-brand-item ms-fun-border">
                        <div class="ms-fun-brand-top mb-20">
                            <div class="ms-fun-brand-thumb">
                                <a href="genres-details.html"><img src="assets/img/function-brand/function-brand-04.png"
                                        alt="function brand"></a>
                            </div>
                            <div class="ms-fun-brand-content">
                    ...
                    <div class="ms-fun-brand-item ms-fun-border">
                        <div class="ms-fun-brand-top mb-20">
                            <div class="ms-fun-brand-thumb">
                                <a href="genres-details.html"><img src="assets/img/function-brand/function-brand-07.png"
                                        alt="function brand"></a>
                            </div>
                            <div class="ms-fun-brand-content">
                                <h3 class="ms-fun-brand-title"><a href="genres-details.html">Black Sabbath</a>
                    ...
                    <div class="ms-fun-brand-item ms-fun-border">
                        <div class="ms-fun-brand-top mb-20">
                            <div class="ms-fun-brand-thumb">
                                <a href="genres-details.html"><img src="assets/img/function-brand/function-brand-08.png"
                                        alt="function brand"></a>
                            </div>
                            <div class="ms-fun-brand-content">
                                <h3 class="ms-fun-brand-title"><a href="genres-details.html">The Coasters</a>

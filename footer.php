<footer>
        <div class="ms-footer2-top ms-footer-bg ms-br-15 fix ms-footer-overlay two zindex-1 include__bg pt-130 pb-10 ms-maw-1810 mx-auto"
            data-background="assets/img/bg/work-bg.jpg">
            <div class="container">
                <div class="ms-footer2-top-inner ms-br-100 ms-bg-4 mb-65">
                    <div class="row align-items-center">
                        <div class="col-xl-2 col-lg-3 col-md-4">
                            <div class="ms-footer2-logo m-img mb-5">
                                <a href="index-2.html"><img src="assets/img/logo/footer-logo.png" alt="footer logo"></a>
                            </div>
                        </div>
                        <div class="col-xl-4 col-lg-3 col-md-6">
                            <div class="ms-social-border two p-relative">
                ...
                <div class="row">
                    <div class="col-xxl-4 col-lg-5 col-md-6">
                        <div class="ms-footer2-widget mb-50 pr-20">
                            ...
                            <div class="ms-footer2-contact pb-30">
                                <ul>
                                    <li><i class="flaticon-pin"></i><a href="#">936 Kuhl Avenue, Norcross,
                                            Georgia
                                            GA 5983, United State</a></li>
                                    <li><i class="flaticon-phone-call"></i><a href="tel:03332920560">0333 292
                                            0560</a></li>
                                    
                                </ul>
                            </div>
                            <div class="ms-footer2-rating pt-25">
                                <h3>Excellent : 1050 Review On <a href="#"><img src="assets/img/footer/start-01.png"
                                            alt="footer image"></a></h3>
                            </div>
                        </div>
                    </div>
                    <div class="col-xxl-2 col-lg-4 col-md-6">
                        <div class="ms-footer2-widget ms-footer2-widget2 mb-50">
                            ...
                            <ul>
                                ...
                                <li><a href="contect.php">Help & Support</a></li>
                            </ul>
                        </div>
                    </div>
